...
public class ManageCategory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(1051, 689));
        setMinimumSize(new java.awt.Dimension(1051, 689));
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(1051, 689));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 310, 310, 300));
        ...
        getContentPane().add(txtCategory, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 190, 310, 40));
        ...
        getContentPane().add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 250, 130, 40));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 250, 130, 40));

        jLabel2.setFont(new java.awt.Font("Sitka Text", 1, 48)); // NOI18N
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/categ.png"))); // NOI18N
        jLabel2.setText("Add or Delete Category");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 70, -1, 70));
        ...
        jLabel3.setMaximumSize(new java.awt.Dimension(1051, 636));
        jLabel3.setMinimumSize(new java.awt.Dimension(1051, 636));
        jLabel3.setPreferredSize(new java.awt.Dimension(1051, 636));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        CategoryDao.save(category, conn);
        setVisible(false);
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        while(itr.hasNext()){
            ...
            dtm.addRow(new Object[]{categoryObj.getName()});
        }
    ...
    private void btnClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClearActionPerformed
        ...
        String id = model.getValueAt(index,0).toString();
        String name = model.getValueAt(index,1).toString();
        int a = JOptionPane.showConfirmDialog(null, "Do you really want to delete "+name+" from Categories ?","Select",JOptionPane.YES_NO_OPTION);
        if(a==0){
            CategoryDao.delete(id, conn);
            setVisible(false);
            new ManageCategory().setVisible(true);
